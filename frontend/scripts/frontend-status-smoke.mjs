...
const DEFAULT_EXPECTED_LABELS = ["OCR In Progress", "Translating", "Rendering", "Processing Complete"];
...
Options:
  ...
  --expect-labels <csv>      Expected labels, default OCR In Progress,Translating,Rendering,Processing Complete
