class JobStatusCard extends HTMLElement {
    ...
    this.innerHTML = `
      ...
      <div class="status-ring-shell">
        <div class="status-focus-card">
          ...
          <div id="status-ring-label" class="status-ring-label">Waiting</div>
          <div id="status-ring-value" class="status-ring-value">Preparing</div>
          <div id="status-ring-elapsed" class="status-ring-elapsed">0s</div>
  ...
  setStagePresentation({ label = "Waiting", value = "Preparing", iconMarkup = "" } = {}) {
