    ...
    this.innerHTML = `
      <header class="topbar">
        ...
        <div class="hero-actions">
          <button id="developer-btn" type="button" class="secondary">Developer</button>
          <button id="open-output-btn" type="button" class="secondary hidden">Open Output Directory</button>
        </div>
      </header>
