...
def test_build_case_drift_summary_detects_strategy_shift() -> None:
    ...
    replay_payload = {
        ...
        "replay_result": {
            "translated_text": "Geometry optimization and energy calculations.",
...
def test_generate_tests_uses_case_artifact_when_job_root_is_missing(monkeypatch) -> None:
    with tempfile.TemporaryDirectory() as tmp:
            ...
            json.dumps(
                {
                    ...
                    "saved": {
                        "snapshot": {
                            ...
                            "translated_text": "Translation solely from artifact.",
        ...
        assert tests[0]["vars"]["saved_text"] == "Translation solely from artifact."
