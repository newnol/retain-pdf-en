        ...
        0: [
            {
                ...
                "translated_text": "This is a Chinese translation.",
...
def test_replay_translation_item_recovers_env_api_key_from_job_db(monkeypatch) -> None:
    ...
    def _fake_translate_batch(_batch, **kwargs):
        ...
        return {
            "p001-b001": {
                "decision": "translate",
                "translated_text": "Recovered the key from the database.",
                "final_status": "translated",
            }
        }
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        def _fake_translate_batch(batch, **kwargs):
            ...
            return {
                batch[0]["item_id"]: {
                    "decision": "translate",
                    "translated_text": "Frozen input replay successful.",
                    "final_status": "translated",
                }
            }
        ...
        assert result["replay_result"]["translated_text"] == "Frozen input replay successful."
