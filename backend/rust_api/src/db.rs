...
impl Db {
    ...
    pub fn recover_stale_running_job(
        ...
        let failure = JobFailureInfo {
            ...
            upstream_host: None,
            provider: None,
            suggestion: Some("The worker for this task is no longer running; please resubmit or retry manually".to_string()),
...
mod tests {
    ...
    fn save_job_persists_runtime_and_failure_json() {
        ...
        job.replace_failure_info(Some(JobFailureInfo {
            ...
            root_cause: Some("Test failure attribution".to_string()),
            retryable: true,
