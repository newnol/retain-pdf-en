...
mod tests {
    ...
    async fn job_detail_route_prefers_formal_failure_fields() {
        ...
        job.failure = Some(crate::models::JobFailureInfo {
            ...
            suggestion: Some("Check provider token".to_string()),
    ...
    async fn job_events_route_prefers_formal_failure_fields() {
        ...
        job.replace_failure_info(Some(JobFailureInfo {
            ...
            suggestion: Some("Retry later".to_string()),
    ...
    async fn job_detail_route_prefers_live_pipeline_stage_snapshot() {
        ...
        fs::write(
            job_root.join("logs").join("pipeline_events.jsonl"),
            concat!(
                r#"{"job_id":"job-route-live-stage","seq":1,"ts":"2026-04-24T01:00:00Z","level":"info","stage":"translating","stage_detail":"Completed batch 2/5 of translation","provider":"","provider_stage":"","event_type":"stage_progress","message":"Completed batch 2/5 of translation","progress_current":2,"progress_total":5,"retry_count":0,"elapsed_ms":1000,"payload":{}}"#,
                "\n",
                r#"{"job_id":"job-route-live-stage","seq":2,"ts":"2026-04-24T01:00:01Z","level":"info","stage":"saving","stage_detail":"Final PDF published","provider":"","provider_stage":"","event_type":"artifact_published","message":"Final PDF published","progress_current":null,"progress_total":null,"retry_count":0,"elapsed_ms":1100,"payload":{"artifact_key":"output_pdf"}}"#,
                "\n"
            ),
        )
        .expect("write pipeline events");
        ...
        assert_eq!(detail_json["data"]["stage_detail"], "Completed batch 2/5 of translation");
    ...
    async fn jobs_list_route_prefers_live_pipeline_stage_snapshot() {
        ...
        fs::write(
            job_root.join("logs").join("pipeline_events.jsonl"),
            concat!(
                r#"{"job_id":"job-route-list-live-stage","seq":1,"ts":"2026-04-24T01:00:00Z","level":"info","stage":"translating","stage_detail":"Completed batch 3/8 of translation","provider":"","provider_stage":"","event_type":"stage_progress","message":"Completed batch 3/8 of translation","progress_current":3,"progress_total":8,"retry_count":0,"elapsed_ms":900,"payload":{}}"#,
                "\n",
                r#"{"job_id":"job-route-list-live-stage","seq":2,"ts":"2026-04-24T01:00:01Z","level":"info","stage":"saving","stage_detail":"Final PDF published","provider":"","provider_stage":"","event_type":"artifact_published","message":"Final PDF published","progress_current":null,"progress_total":null,"retry_count":0,"elapsed_ms":1000,"payload":{"artifact_key":"output_pdf"}}"#,
                "\n"
            ),
        )
        .expect("write pipeline events");
    ...
    async fn job_detail_list_and_events_share_pipeline_event_priority() {
        ...
        fs::write(
            job_root.join("logs").join("pipeline_events.jsonl"),
            concat!(
                r#"{"job_id":"job-route-shared-live-stage","seq":1,"ts":"2026-04-24T01:00:00Z","level":"info","stage":"translating","stage_detail":"Completed batch 4/9 of translation","provider":"","provider_stage":"","event":"stage_progress","message":"Completed batch 4/9 of translation","progress_current":4,"progress_total":9,"retry_count":0,"elapsed_ms":900,"payload":{"origin":"python"}}"#,
                "\n",
                r#"{"job_id":"job-route-shared-live-stage","seq":2,"ts":"2026-04-24T01:00:01Z","level":"info","stage":"saving","stage_detail":"Final PDF published","provider":"","provider_stage":"","event":"artifact_published","message":"Final PDF published","progress_current":null,"progress_total":null,"retry_count":0,"elapsed_ms":1000,"payload":{"artifact_key":"output_pdf"}}"#,
                "\n"
            ),
        )
        .expect("write pipeline events");
        ...
        let detail_json = read_json(detail_response).await;
        assert_eq!(detail_json["data"]["stage"], "translating");
        assert_eq!(detail_json["data"]["stage_detail"], "Completed batch 4/9 of translation");
